...
f5=np.load('FVCOM_GOM3_GoMOOS_E01_201405.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_201406.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_201407.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_201408.npy').tolist()
...
t1=datetime(2014,5,1,0,0,0)
t2=datetime(2014,8,31,0,0,0)
...
plt.savefig('mooring E2014-5-1 TO 2014-8-31',dpi=700)
