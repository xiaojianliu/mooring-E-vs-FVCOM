...
#    print w
    ...
    return fm
URL='E0121.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_200709.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_200710.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_200711.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_200712.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_E01_200801.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_E01_200802.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_E01_200803.npy').tolist()


f12=np.load('FVCOM_GOM3_GoMOOS_E01_200804.npy').tolist()
'''
...
plt.savefig('mooring E2007-9-18 TO 2008-4-20',dpi=400)
