...
#    print w
    ...
    return fm
URL='E0120.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_200705.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_200706.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_200707.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_200708.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_E01_200709.npy').tolist()
'''
f10=np.load('FVCOM_GOM3_GoMOOS_E01_200212.npy').tolist()
...
plt.savefig('mooring E2007-5-9 TO 2007-9-18',dpi=400)
