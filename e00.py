...
#    print w
    ...
    return fm
URL='E0127.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_201106.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_201107.npy').tolist()
...
plt.savefig('mooring E2011-6-4 TO 2012-3-12',dpi=400)
