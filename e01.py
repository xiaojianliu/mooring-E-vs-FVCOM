...
#    print w
    ...
    return fm
URL='E0128.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_201203.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_201204.npy').tolist()
'''
f7=np.load('FVCOM_GOM3_GoMOOS_E01_201108.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_201109.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_E01_201110.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_E01_201111.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_E01_201112.npy').tolist()


f12=np.load('FVCOM_GOM3_GoMOOS_E01_201201.npy').tolist()
f13=np.load('FVCOM_GOM3_GoMOOS_E01_201202.npy').tolist()

f14=np.load('FVCOM_GOM3_GoMOOS_E01_201203.npy').tolist()

f15=np.load('FVCOM_GOM3_GoMOOS_E01_201104.npy').tolist()
f16=np.load('FVCOM_GOM3_GoMOOS_E01_201105.npy').tolist()

f17=np.load('FVCOM_GOM3_GoMOOS_E01_201106.npy').tolist()
...
plt.savefig('mooring E2012-3-12 TO 2012-4-14',dpi=400)
