...
#    print w
    ...
    return fm
URL='E0123.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_200809.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_200810.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_200811.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_200812.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_E01_200901.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_E01_200902.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_E01_200903.npy').tolist()
'''
...
plt.savefig('mooring E2008-9-25 TO 2009-3-21',dpi=400)
