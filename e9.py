...
#    print w
    ...
    return fm
URL='E0125.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_200909.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_200910.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_200911.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_200912.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_E01_201001.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_E01_201002.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_E01_201003.npy').tolist()


f12=np.load('FVCOM_GOM3_GoMOOS_E01_201004.npy').tolist()
f13=np.load('FVCOM_GOM3_GoMOOS_E01_201005.npy').tolist()

f14=np.load('FVCOM_GOM3_GoMOOS_E01_201006.npy').tolist()
'''
...
plt.savefig('mooring E2009-9-16 TO 2010-6-2',dpi=400)
