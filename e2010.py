...
f5=np.load('FVCOM_GOM3_GoMOOS_E01_201005.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_201006.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_201007.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_201008.npy').tolist()
...
t1=datetime(2010,5,1,0,0,0)
t2=datetime(2010,8,31,0,0,0)
...
plt.savefig('mooring E2010-5-1 TO 2010-8-31',dpi=700)
