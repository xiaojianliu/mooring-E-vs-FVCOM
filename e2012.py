...
f5=np.load('FVCOM_GOM3_GoMOOS_E01_201205.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_201206.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_201207.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_201208.npy').tolist()
...
t1=datetime(2012,5,1,0,0,0)
t2=datetime(2012,8,31,0,0,0)
...
index2=np.argmin(abs(np.array(t)-t2))
t0=[]
currentu=[]
...
plt.savefig('mooring E2012-5-1 TO 2012-8-31',dpi=700)
