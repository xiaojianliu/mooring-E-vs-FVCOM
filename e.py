...
#    print w
    ...
    return fm
URL='E0122.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_200804.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_200805.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_200806.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_200807.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_E01_200808.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_E01_200809.npy').tolist()
'''
f11=np.load('FVCOM_GOM3_GoMOOS_E01_200410.npy').tolist()
...
plt.savefig('mooring E2008-4-21 TO 2008-9-24',dpi=400)
