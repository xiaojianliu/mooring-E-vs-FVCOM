...
#    print w
    ...
    return fm
URL='E0116.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_200510.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_200511.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_200512.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_200601.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_E01_200602.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_E01_200603.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_E01_200604.npy').tolist()
'''

f12=np.load('FVCOM_GOM3_GoMOOS_E01_200310.npy').tolist()
...
plt.savefig('mooring E2005-10-11 TO 2006-4-12',dpi=400)
