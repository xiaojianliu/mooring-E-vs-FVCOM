...
#    print w
    ...
    return fm
URL='E0133.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_201506.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_201507.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_201508.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_201509.npy').tolist()
...
plt.savefig('mooring E2015-6-6 TO 2015-12-31',dpi=400)
