...
#    print w
    ...
    return fm
URL='E0132.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_201409.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_201410.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_201411.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_201412.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_E01_201501.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_E01_201502.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_E01_201503.npy').tolist()


f12=np.load('FVCOM_GOM3_GoMOOS_E01_201504.npy').tolist()

f13=np.load('FVCOM_GOM3_GoMOOS_E01_201505.npy').tolist()

f14=np.load('FVCOM_GOM3_GoMOOS_E01_201506.npy').tolist()
'''
...
plt.savefig('mooring E2014-9-19 TO 2015-6-5',dpi=400)
