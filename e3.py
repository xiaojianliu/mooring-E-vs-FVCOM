...
#    print w
    ...
    return fm
URL='E0131.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_201406.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_201407.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_201408.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_201409.npy').tolist()
'''

f9=np.load('FVCOM_GOM3_GoMOOS_E01_200704.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_E01_200705.npy').tolist()
...
plt.savefig('mooring E2014-6-2 TO 2014-9-19',dpi=400)
