...
f5=np.load('FVCOM_GOM3_GoMOOS_E01_201204.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_201205.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_201206.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_201207.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_E01_201208.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_E01_201209.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_E01_201210.npy').tolist()


f12=np.load('FVCOM_GOM3_GoMOOS_E01_201211.npy').tolist()
f13=np.load('FVCOM_GOM3_GoMOOS_E01_201212.npy').tolist()

f14=np.load('FVCOM_GOM3_GoMOOS_E01_201301.npy').tolist()

f15=np.load('FVCOM_GOM3_GoMOOS_E01_201302.npy').tolist()
f16=np.load('FVCOM_GOM3_GoMOOS_E01_201303.npy').tolist()

f17=np.load('FVCOM_GOM3_GoMOOS_E01_201304.npy').tolist()

f18=np.load('FVCOM_GOM3_GoMOOS_E01_201305.npy').tolist()
...
plt.savefig('mooring E2012-4-15 TO 2013-6-24',dpi=400)
