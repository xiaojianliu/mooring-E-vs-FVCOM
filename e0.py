...
#    print w
    ...
    return fm
URL='E0126.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_201006.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_201007.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_201008.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_201009.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_E01_201010.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_E01_201011.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_E01_201012.npy').tolist()


f12=np.load('FVCOM_GOM3_GoMOOS_E01_201101.npy').tolist()
f13=np.load('FVCOM_GOM3_GoMOOS_E01_201102.npy').tolist()

f14=np.load('FVCOM_GOM3_GoMOOS_E01_201103.npy').tolist()
...
plt.savefig('mooring E2010-6-2 TO 2011-6-4',dpi=400)
