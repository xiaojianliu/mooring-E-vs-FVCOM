...
f5=np.load('FVCOM_GOM3_GoMOOS_E01_201105.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_201106.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_201107.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_201108.npy').tolist()
...
t1=datetime(2011,5,1,0,0,0)
t2=datetime(2011,8,31,0,0,0)
...
plt.savefig('mooring E2011-5-1 TO 2011-8-31',dpi=700)
