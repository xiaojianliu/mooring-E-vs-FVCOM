...
#    print w
    ...
    return fm
URL='E0124.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_E01_200903.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_E01_200904.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_E01_200905.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_E01_200906.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_E01_200907.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_E01_200908.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_E01_200909.npy').tolist()
'''
...
plt.savefig('mooring E2009-3-22 TO 2009-9-15',dpi=400)
